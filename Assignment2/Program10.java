...
int calculateCreditScore(){
    ...
    return ((credit_history*15)+((int)(credit_utilization*30))+35);
}
}
...
public class Program10 {
    public static void main(String[] args) {
        ...
        boolean flag;//flag is a boolean varaiable
        if(sc.nextInt()==1)
        {
           flag=true;
        }
        ...
        int credit_score=csc.calculateCreditScore();
        System.out.println("Credit Score is "+ credit_score);      
    }   
}
